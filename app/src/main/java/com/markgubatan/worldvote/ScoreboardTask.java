...
/**
 * Created by Mark Gubatan on 12/3/2014.
 */
public class ScoreboardTask extends AsyncTask<Void, Void, ArrayList<Person>> {
    ...
    public ArrayList<Person> searchPerson = new ArrayList<Person>();

    public ScoreboardTask(OnSearchCompleteListener onSearchCompleteListener) {
        super();
    ...
    protected ArrayList<Person> doInBackground(Void... params) {
        ...
        String query = "http://worldvote.herokuapp.com/markScoreboard";
    ...
    @Override
    protected void onPostExecute(ArrayList<Person> searchPerson) {
